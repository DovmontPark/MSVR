...
function draw() {
    ...
    const leftModelViewProjection = m4.multiply(stereoCamera.ProjectionMatrix, m4.multiply(stereoCamera.ModelViewMatrix, m4.multiply(matAccum1, m4.zRotation(heading * Math.PI / 180))));
    gl.uniformMatrix4fv(sh_prog.iModelViewProjectionMatrix, false, leftModelViewProjection);
    geometry.Draw();
    gl.clear(gl.DEPTH_BUFFER_BIT);
    stereoCamera.ApplyRightFrustum();
    gl.colorMask(false, true, true, false);
    const rightModelViewProjection = m4.multiply(stereoCamera.ProjectionMatrix, m4.multiply(stereoCamera.ModelViewMatrix, m4.multiply(matAccum1, m4.zRotation(heading * Math.PI / 180))));
